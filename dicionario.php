...
<?php
  ...
  if(isset($_POST["pesquisa"])){
    ...
    $sql = "(SELECT * FROM ".$tb_animal." WHERE nome LIKE '%".$pesquisa."%' ORDER BY nome ASC)union(SELECT * FROM ".$tb_comidas." WHERE nome LIKE '%".$pesquisa."%' ORDER BY nome ASC)union(SELECT * FROM ".$tb_gestos." WHERE nome LIKE '%".$pesquisa."%' ORDER BY nome ASC)";
