...
<body>        
    ...
    <form method="post">
    <b><h4 class="center">Tipo Comida</h4></b>
    <a href="cad_tipoComida.php">Cadastrar</a>
                    <label>
                ...
                <table border="1">
                    <?php
                        if ($pesquisa == '') {
                            $sql = "SELECT * FROM ".$tb_tipoComida;
                        }
                        elseif ($campo =='codigo'){
                            $sql = "SELECT * FROM ".$tb_tipoComida." WHERE codigo = ".$pesquisa." order by ".$campo;
                        }
                        elseif ($campo =='tipo'){
                            $sql = "SELECT * FROM ".$tb_tipoComida." WHERE tipo LIKE '".$pesquisa."%' order by ".$campo;
                        }
                        ...
                        <?php
                            ...
                            while ($cont < count($row)){
                                echo "<tr>
                                        <td>".$row[$cont][0]."</td>
                                        <td>".$row[$cont][1]."</td>
                                        <td><a onclick='excluirRegistro()' href='acao.php?tabela=".$tb_tipoComida."&acao=excluir&codigo=".$row[$cont][0]."'><i class='material-icons'>delete</i></a></td>
                                        <td><a href='cad_tipoComida.php?id={$row[$cont][0]}'><i class='material-icons'>update</i></a></td>
                                      </tr>";
                                      $cont++;
                            }
                        ?>
        ...
        <b><h4 class="center">comida</h4></b>
    <a href="cad_comida.php">Cadastrar</a>
                ...
                <table border="1">
                    <?php
                        if ($pesquisa3 == '' or $campo3 == "") {
                            $sql = "SELECT a.codigo, nome, linkImg, linkVid, ta.tipo FROM $tb_comida a, $tb_tipoComida ta WHERE a.tipoCodigo=ta.codigo";
                        }


                        elseif ($campo3 =='codigo'){
                            $sql = "SELECT * FROM ".$tb_comida." WHERE codigo = ".$pesquisa3." order by ".$campo3;
                        }
                        elseif ($campo3 =='nome'){
                            $sql = "SELECT * FROM ".$tb_comida." WHERE nome LIKE '".$pesquisa3."%' order by ".$campo3;
                        }
                        elseif ($campo3 =='linkImg'){
                            $sql = "SELECT * FROM ".$tb_comida." WHERE linkImg LIKE '".$pesquisa3."%' order by ".$campo3;
                        }
                        elseif ($campo3 =='linkVid'){
                            $sql = "SELECT * FROM ".$tb_comida." WHERE linkVid LIKE '".$pesquisa3."%' order by ".$campo3;
                        }
                        elseif ($campo3 =='tipoCodigo'){
                            $sql = "SELECT * FROM ".$tb_comida." WHERE tipoCodigo LIKE '".$pesquisa3."%' order by ".$campo3;
                        }
                        ...
                        <?php
                            ...
                            while ($cont < count($row)){
                                echo "<tr>
                                        ...
                                        <td>-</td>
                                        <td>".$row[$cont][4]."</td>
                                        <td><a onclick='excluirRegistro()' href='acao.php?tabela=".$tb_comida."&acao=excluir&codigo=".$row[$cont][0]."'><i class='material-icons'>delete</i></a></td>
                                        <td><a href='cad_comida.php?id={$row[$cont][0]}'><i class='material-icons'>update</i></a></td>
                                      </tr>";
                                      $cont++;
                            }
