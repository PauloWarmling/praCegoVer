...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right navbar-uppercase">
                    <li>
                        <a href="" target="_blank">Animais</a>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-danger">
                            <li>
                                <a href="#"><i class="fa fa-facebook-square"></i> algp aq</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-twitter"></i>algp aq</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-instagram"></i> algp aq</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="" class="btn btn-danger btn-fill">Tradutor</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="container">
                <div class="content">
                    <div class="title-area">
                        <p>Libras</p>
                        <h1 class="title-modern">SrLab</h1>
                        <h3>Para você se comunicar com o mundo!</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="title-area">
                    ...
                    <p class="description">Tentamos ajudar as pessoas que não querem se comunicar com alguém especial mas não sabe como, promovendo assim mais inclusão por meio de um site interativo</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="info-icon">
                        ...
                        <h3>Tradutor</h3>
                        <p class="description">Sua frase será traduzida para o idioma Brasileiro de libras.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="info-icon">
                        ...
                        <h3>Comunicação</h3>
                        <p class="description">Aqui você encontra uma sério de gestos basicos para comunicação basica entre ouvintes.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="info-icon">
                        ...
                        <h3>Gesticulações</h3>
                        <p class="description">Aprenda gesticulações com um profissional de libras.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section section-our-clients-freebie">
        <div class="container">
            <div class="title-area">
                <h5 class="subtitle text-gray">Quem somos</h5>
                <h2></h2>
                <div class="separator separator-danger">∎</div>
            </div>
        ...
        <div class="parallax filter">
            ...
            <div class="container">
                <div class="title-area">
                    ...
                    <div class="separator line-separator">♦</div>
                    <p class="description"> Informe-nos sobre problemas ou sugestões para aprimorarmos nosso site</p>
                </div>

                <div class="button-get-started">
                    <a href="#gaia" class="btn btn-danger btn-fill btn-lg">Fale Conosco</a>
                </div>
            </div>
        </div>
    </div>
